...
abstract class AbstractSearchAsyncAction<Result extends SearchPhaseResult> extends SearchPhase implements SearchPhaseContext {
    ...
    public final void start() {
        ...
        try {
            cachedSerializedSourceVersion = clusterState.nodes().getMinNodeVersion();
            cachedSerializedSource = request.getOrCreateSerializedSource(cachedSerializedSourceVersion);
        } catch (Exception e) {
    ...
    public final ShardSearchRequest buildShardSearchRequest(SearchShardIterator shardIt) {
        ...
        if (cachedSerializedSource != null) {
            shardRequest.setCachedSerializedSource(cachedSerializedSource, cachedSerializedSourceVersion);
        }
